...
class PreConfigureDifficulty extends Controller
{
    use Common;
    ...
    public function index(Request $request){
        try{
            ...
            // echo "<pre>";print_r($globalConfigValue->toArray());die;
    ...
    public function create(){
        try{
            ...
            return back()->with('error_msg', __('languages.problem_was_occured_please_try_again'));
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        $PostData =array(
            ...
            cn::PRE_CONFIGURE_DIFFICULTY_DIFFICULTY_LEVEL_NAME_COL => $request->difficult_level_name,
        ...
        if(PreConfigurationDiffiltyLevel::where(cn::PRE_CONFIGURE_DIFFICULTY_DIFFICULTY_LEVEL_COL,$request->difficulty_level)->doesntExist()){
            ...
            if(!empty($PreConfigureDiffiltyLevel)){
               $this->AuditLogfuncation($PostData,'PreConfigurationDiffiltyLevel','','','Create Pre Configure Difficulty Level',cn::PRE_CONFIGURE_DIFFICULTY_TABLE_NAME,'');
    ...
    public function update(Request $request, $id){
        ...
        if($update){
            $this->AuditLogfuncation($PostData,'PreConfigurationDiffiltyLevel','','','Update Pre Configure Difficulty Level',cn::PRE_CONFIGURE_DIFFICULTY_ID_COL,'');
    ...
    public function destroy($id){
        try{
            ...
            $this->AuditLogfuncation('','PreConfigurationDiffiltyLevel','','','Delete Pre Configure Difficulty Level ID '.$id,cn::PRE_CONFIGURE_DIFFICULTY_ID_COL,'');
