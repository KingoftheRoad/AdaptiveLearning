                    ...
                    <div class="row">
						<div class="col-md-12">
							<div class="sec-title">
                                ...
                                @else
                                    <a href="{{ route('getStudentExamList') }}" class="btn-back" >{{__('languages.back')}}</a>
                                @endif
							</div>
							<hr class="blue-line">
						</div>
                            ...
                            @if(!empty($Questions))
                                ...
                                @foreach($Questions as $key => $question)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="sm-answer pl-5 pt-2"><span class="badge badge-success getSolutionQuestionImage" data-question-node ="{{$question->naming_structure_code}}">{{__('languages.full_question_solution')}}</span>                                            
