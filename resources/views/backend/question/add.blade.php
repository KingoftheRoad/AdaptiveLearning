							...
							<div class="row">
								<div class="col-lg-2 col-md-3">
									<div class="select-lng pt-2 pb-2">
										<select name="grade_id" class="form-control select-option" id="grade-id" disabled style="display:none;">
											@if(!empty($Grades))
												<option value="">{{ __('languages.select_grade') }}</option>
												@foreach($Grades as $gradeKey => $grade)
												<option value={{$grade->id}} {{ ($gradeKey == 3) ? 'selected' : '' }} >{{ ucfirst($grade->name) }}</option> 
												@endforeach
											@else
								...
								<div class="col-lg-2 col-md-3">
									<div class="select-lng pt-2 pb-2">
										<?php //$subjects = Session::get('subjects'); ?>
										<select name="subject_id" class="form-control select-option" id="subject-id" @if(isset($subjects) && !empty($subjects)) "style=display:block;" @else "style=display:none;" @endif disabled style="display:none;">
											<option value="">{{ __('languages.subject') }}</option>
											@if(!empty($subjects))
											@foreach($subjects as $subjectKey => $subject)
												<option value="{{$subject->id}}" {{ ($subjectKey == 0) ? 'selected' : '' }}>{{$subject->name}}</option>
								...
								<div class="col-lg-2 col-md-3">
									<div class="select-lng pt-2 pb-2">
									<?php //$strands = Session::get('strands'); ?>
										<select name="strand_id" class="form-control select-option" id="strand-id" disabled style="display:none;">
											<option value="">{{ __('languages.strands') }}</option>
											@if(!empty($strands))
											@foreach($strands as $strandKey => $strand)
											<option value="{{$strand->id}}" {{ ($strandKey == 0) ? 'selected' : '' }}>{{$strand->name}}</option>
											@endforeach
											@endif
										</select>
								...
								<div class="col-lg-2 col-md-3">
									<div class="select-lng pt-2 pb-2">
									<?php //$LearningUnits = Session::get('LearningUnits'); ?>
										<select name="learning_unit_id"  class="form-control select-option" id="learning-unit" disabled style="display:none;">
											...
											<option value="{{$LearningUnit->id}}" {{ ($learningUnitKey == 0) ? 'selected' : '' }}>{{$LearningUnit->name}}</option>
											@endforeach
											@endif  
										</select>
								...
								<div class="col-lg-2 col-md-3">
									<div class="select-lng pt-2 pb-2">
									<?php //$LearningObjectives = Session::get('LearningObjectives'); ?>
										<select name="learning_objective_id"  class="form-control select-option" id="learning-objectives" disabled style="display:none;">
											<option value="">{{ __('languages.learning_objectives') }}</option>
											@if(!empty($LearningObjectives))
											@foreach($LearningObjectives as $learningObjectivesKey => $LearningObjective)
											<option value="{{$LearningObjective->id}}" {{ ($learningObjectivesKey == 0) ? 'selected' : '' }}>{{$LearningObjective->foci_number}} {{$LearningObjective->title}}</option>
											@endforeach
											@endif
										</select>
