                        ...
                        <form class="user-form" method="post" id="editStudentForm"  action="{{ route('Student.update',$user->id) }}">
                            ...
                            <div class="form-row">
                                        ...
                                        @if(!empty($grades))
                                            ...
                                            @if(!empty($grades))
                                                @foreach($grades as $grade)
                                                    <option value="{{$grade->id}}" @if($grade->id==$user->grade_id) selected @else disabled @endif>{{ $grade->name}}</option>
                                                @endforeach
                                            @endif
                                        @else
                                ...
                                <div class="form-group col-md-6 mb-50">
                                    ...
                                    <select name="class_id" class="form-control select-option" id="School-studentclassType-option">
                                        ...
                                        @if(!empty($user))
                                        <option value="{{$user->class_id}}" selected>{{$user->class}}</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 mb-50">
                                    ...
                                    <input type="text" class="form-control" name="student_number" id="student_number" placeholder="{{ __('languages.class_student_number') }}" value="{{$user->student_number_within_class}}" readonly>
                                ...
                                <div class="form-group col-md-6 mb-50">
                                    ...
                                    <input type="text" class="form-control" name="student_number_with_class" id="student_number_with_class" placeholder="{{__('languages.student_number_with_class')}}" value="{{$user->class_student_number}}" readonly>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 mb-50">
                                    ...
                                    <input type="text" class="form-control" id="permanent_refrence_number" name="permanent_refrence_number" placeholder="{{ __('languages.permanent_reference_number') }}" value="{{$user->permanent_reference_number}}">
