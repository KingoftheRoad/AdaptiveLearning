			...
			<div class="container-fluid">
				...
				{{--<div class="row pt-2">
					<div class="col-md-3 col-lg-6 col-sm-2">
						<a href="{{route('generate-questions',['type'=>2])}}" class="btn btn-success">Create New Excercise</a>
					</div>
					<div class="col-md-3 col-lg-6 col-sm-2">
						<a href="{{route('generate-questions',['type'=>3])}}" class="btn btn-success">Create New Test</a>
					</div>
				</div>--}}
